...
We'll create the following policies:
...
| api-data-operations | GetValuation, CreateDerivedPortfolio, GetPortfolioChanges, ReconcileValuation, GetHoldingsWithOrders, SetHoldings, GetTransactions, GetHoldingsAdjustment, CancelTransactions, GetHoldings, GetDetails, BuildTransactions, CreatePortfolio, ReconcileInline, CancelAdjustHoldings, AdjustHoldings, SearchProperties, SearchPortfolioGroups, SearchPortfolios, ReconcileHoldingsPreview, ListScopes, ReconcileHoldings, DeleteInstrument, DeletePortfolioGroup, UpsertQuotes, ListQuotesForScope, ListQuotes, GetQuotes, DeleteQuotes, ListPortfoliosForScope, UpdatePortfolio, ListPortfolios, GetPortfolioProperties, GetPortfolio, UpsertGroupProperties, DeletePortfolio, UpdatePortfolioGroup, ListPortfolioGroups, GetPortfolioGroup, GetGroupProperties, DeleteGroupProperties, CreatePortfolioGroup, DeletePortfolioFromGroup, DeleteInstrumentProperties, BuildTransactionsForPortfolioGroup, GetPortfolioGroupAccessMetadataByKey, UpsertInstrumentsProperties, AddPortfolioToGroup, GetPortfolioGroupMetadata, UpsertInstruments, GetInstrumentIdentifierTypes, UpdateInstrumentIdentifier, ListInstruments, GetInstruments, GetInstrumentPropertyTimeSeries, GetInstrumentProperties, GetInstrument
|===
