...
You can import the instruments that those holdings are based on, by running the following code:
...
And set the holdings themselves, by running the following code:
