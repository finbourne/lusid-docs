...
include::example$ibor/test_ibor.py[tag="get-holdings-first-day-trading-shk", indent=0]
----
...
include::example$ibor/test_ibor.py[tag="get-holdings-second-day-trading-shk", indent=0]
----
