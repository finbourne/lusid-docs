...
[source, python, indent=0]
----
include::example$holdings.py[tag="get-holdings-funds-loaded"]
----
...
[source, python, indent=0]
----
include::example$holdings.py[tag="get-holdings-first-day-trading"]
----
...
[source, python, indent=0]
----
include::example$holdings.py[tag="get-holdings-second-day-trading"]
----
...
[source, python, indent=0]
----
include::example$holdings.py[tag="get-holdings-today"]
----
...
[source, python, indent=0]
----
include::example$holdings.py[tag="get-holdings-positions"]
----
