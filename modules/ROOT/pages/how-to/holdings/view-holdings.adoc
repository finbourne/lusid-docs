...
[source, python]
----
include::example$holdings.py[tag="get-holdings-first-day-trading", indent=0]
include::example$ibor/test_ibor.py[tag="get-holdings-first-day-trading", indent=0]
----
...
The amount of USD has reduced by 142,716 to 857,284, which is exactly the amount of cash that we spent on the Amazon shares.
...
[source, python]
----
include::example$holdings.py[tag="get-holdings-second-day-trading", indent=0]
include::example$ibor/test_ibor.py[tag="get-holdings-second-day-trading", indent=0]
----
