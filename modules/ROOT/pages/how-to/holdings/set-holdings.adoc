...
This guide assumes that you have xref:how-to/portfolios/load-transaction-portfolio.adoc[created a transaction portfolio] and imported the instruments described in xref:how-to/maintain-instruments-master.adoc[].
