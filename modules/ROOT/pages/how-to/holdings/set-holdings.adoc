...
This guide assumes that you have xref:how-to/portfolios/create-transaction-portfolio.adoc[created a transaction portfolio] and imported the instruments described in xref:how-to/maintain-instruments-master.adoc[].
