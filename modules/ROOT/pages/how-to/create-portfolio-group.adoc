...
This guide assumes that you have created transaction portfolio with the codes `uk-portfolio-code` and `us-portfolio-code`.
...
Initialise the Derived Portfolio Groups API:
