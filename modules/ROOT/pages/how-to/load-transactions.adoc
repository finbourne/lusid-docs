...
[NOTE]
====
To import transactions, you will need to have xref:ROOT:how-to/load-transaction-portfolio.adoc[created a transaction portfolio] and xref:ROOT:how-to/maintain-instruments-master.adoc[loaded the instruments] that the transactions are based on.
====
...
For more information about instrument identifiers, see xref:ROOT:how-to/maintain-instruments-master.adoc#instrument-identifier[How to maintain an instruments master: Instrument Identifiers].
...
[source, python, indent=0]
----
include::example$transactions/test_transactions.py[tag="format-transactions"]
----
