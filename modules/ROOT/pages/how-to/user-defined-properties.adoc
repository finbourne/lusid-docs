...
For an example of how to use a user defined property with a transaction portfolio, see xref:ROOT:how-to/load-transaction-portfolio.adoc#user-defined-properties[Adding a user defined property to a portfolio].
