...
|  `username` | N/A | `<username>` |  Username of the account accessing the API (e.g. email used in xref:how-to/connecting-to-lusid/create-account.adoc[])
|  `password` | N/A | `<password>` |  Password of the account accessing the API (e.g. password used in xref:how-to/connecting-to-lusid/create-account.adoc[])
|===
