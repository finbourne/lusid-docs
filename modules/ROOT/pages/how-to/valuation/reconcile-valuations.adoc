...
In this guide we'll reconcile two valuations.
We can use this approach to compare valuations of the same xref:reference/portfolio/index.adoc[portfolios] at different effective dates or valuations of different portfolios.
