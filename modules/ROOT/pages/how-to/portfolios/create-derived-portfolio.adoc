...
In this guide we'll create a derived portfolio, which can be used to do pre-trade and post-trade what-if analysis.
For more on derived portfolios, see xref:reference/portfolio/derived-portfolio.adoc[].
