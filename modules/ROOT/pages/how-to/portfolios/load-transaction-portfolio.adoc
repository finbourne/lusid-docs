...
In this guide we'll learn how to create a transaction portfolio.
For more on transaction portfolios, see xref:reference/portfolio/transaction-portfolio.adoc[]
