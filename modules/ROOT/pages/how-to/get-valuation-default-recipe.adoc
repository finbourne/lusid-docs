...
These quotes should also have been loaded into LUSID:
...
* To create a transaction portfolio, see xref:how-to/load-transaction-portfolio.adoc[]
...
You can also find the complete worked example used in this guide at {examples-repository-base}/test_ibor.py[test_ibor.py^].
