...
And then initialise the Instruments API:
...
For example, to change the `ClientInternal` identifier for Amazon effective in 10 minutes time, you can run the following:
